...
5. In case you need to open non 12-bit raw files, first rename `DCSPro4SLR.dll` to `DCSPro4SLR-12bit.dll` and then `DCSPro4SLR-original.dll` to `DCSPro4SLR.dll`.
